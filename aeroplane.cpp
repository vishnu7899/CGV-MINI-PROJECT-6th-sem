...
char s2[100]="BALLARI INSTITUTE OF TECNOLOGY AND MANAGEMENT";
char s3[150]="DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING";
char s4[20]="A Mini Project On:-";
char s5[50]="AEROPLANE PLANE CRASH";
char s6[200]="BY POLEPALLI VISHNU SAI AND PINNAKA DEDEEPYA";
char s7[200]="Under the Guidence of :ASST.PROF.MR.DADAPEER";
